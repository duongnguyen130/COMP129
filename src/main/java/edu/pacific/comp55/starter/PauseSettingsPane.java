...
public class PauseSettingsPane extends GraphicsPane {
	...
	public PauseSettingsPane(MainApplication app) {
		this.program = app;

		soundButton = new GButton("Sound: On", 300, 175, 200, 50);
		musicButton = new GButton("Music: On", 300, 250, 200, 50);
		backButton = new GButton("Back to Pause Menu", 300, 325, 200, 50);
	...
	public void showContents() {
		program.setPauseSettingsState(true);
	...
	public void hideContents() {
		program.setPauseSettingsState(false);
