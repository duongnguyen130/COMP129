...
public class TrafficJamPhase2 extends GraphicsPane {
	...
	public static final String ARRAYINDEXOUTOFBOUNDS = "ArrayIndexOutOfBounds.png";
	...
	public TrafficJamPhase2(MainApplication app) {
		super();
		program = app;
	...
	public void mousePressed(MouseEvent e) {
		...
		if(obj instanceof GImage) {
			if(!errorPresent) {
				...
				errorPresent = true;
				error = new GImage(ARRAYINDEXOUTOFBOUNDS, 1 * cellWidth(), 1 * cellHeight());
